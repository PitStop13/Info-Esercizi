...
namespace SimulazioneCompleta
{
    public partial class Form1 : Form
    {
        ...
        private void VisualizzaNumeriMemorizzati()
        {
            ...
            Label lbl = new Label();
            lbl.Text = "Numeri memorizzati:\n" + string.Join("\n", numeriMemorizzati);
            lbl.Location = new Point(10, 550);
            lbl.AutoSize = true;
            lbl.BackColor = Color.LightYellow;
            lbl.Padding = new Padding(10);
            lbl.Font = new Font("Arial", 10);

            var lblMemRmv = this.Controls.OfType<Label>().Where(l=>l.Text.StartsWith("Numeri memorizzati:")).ToList();
            foreach (var l in lblMemRmv)
            {
