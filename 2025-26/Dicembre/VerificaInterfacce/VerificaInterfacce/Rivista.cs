...
namespace VerificaInterfacce
{
    internal class Rivista : ContenutoMultimediale, IPrestabile
    {
        ...
        public void Presta(string nomeUtente, DateTime dataPrestito)
        {
            ...
            {
                throw new InvalidOperationException("La rivista non è disponibile per il prestito.");
            }
        }
        ...
        public void Restituisci()
        {
            ...
            {
                throw new InvalidOperationException("La rivista non è attualmente in prestito.");
            }
        }
